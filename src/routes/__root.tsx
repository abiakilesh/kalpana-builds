...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kalpana Associates & Construction — Chennai" },
      { property: "og:description", content: "Tamil Nadu's first BOQ-based construction company. Transparent. Trusted. Premium." },
